...
?>
	<form action="register.php" method="POST" id="registerForm">
        <label id="regLabel">Registracija</label>
		<label for="username">Uporabniško ime</label><input type="text" name="username" id="username" /> <br/>
		<label for="geslo">Geslo</label><input type="password" name="password" id="geslo" /> <br/>
		<label for="ponoviGeslo">Ponovi geslo</label><input type="password" name="repeat_password" id="ponoviGeslo" /> <br/>
		<input type="submit" name="submit" value="POŠLJI"/> <br/>
        <a href="/RazvojProgramskihSistemov/login.php">PRIJAVA</a> 
